...
public class NotificationEditor extends BasePrefsEditor {
	...
	public static boolean saveIgnoredPackages(Context context, Set<String> ignoredSet) {
		return putStringSet(context, Keys.Notifications.NOTIFICATIONS_IGNORE_SET, ignoredSet);
	}
}
