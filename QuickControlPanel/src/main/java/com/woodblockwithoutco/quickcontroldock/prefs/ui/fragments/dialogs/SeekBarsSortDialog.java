...
public class SeekBarsSortDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		List<String> seekBarsOrderList = TogglesResolver.getSeekbarOrderAsStringList(getActivity());
		mAdapter = new SeekBarsDragAdapter(getActivity().getApplicationContext(), 
		...
		dragList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				SeekbarType seekbarType = SeekbarType.valueOf(type);
				boolean enabled = TogglesResolver.isSeekbarUsed(getActivity(), seekbarType);
				ButtonsEditor.setSeekbarEnabled(getActivity(), seekbarType, !enabled);
		...
		listener = new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				case DialogInterface.BUTTON_POSITIVE:
					ButtonsEditor.saveSeekbarsOrder(getActivity(), mAdapter.getList());
					dismiss();
					break;
