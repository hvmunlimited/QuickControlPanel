...
public class SoundMediaSeekBarAction implements SeekBarAction {

	private Context mContext;
	private AudioManager mAudioManager;
	private final int MAX_MEDIA_VOLUME;
	private Handler mHandler;

	private final static int MSG_SET_VOLUME = 100;

	public SoundMediaSeekBarAction(Context context) {
		mContext = context;
		mAudioManager = (AudioManager) mContext.getSystemService(Context.AUDIO_SERVICE);
		MAX_MEDIA_VOLUME = mAudioManager.getStreamMaxVolume(AudioManager.STREAM_MUSIC);
