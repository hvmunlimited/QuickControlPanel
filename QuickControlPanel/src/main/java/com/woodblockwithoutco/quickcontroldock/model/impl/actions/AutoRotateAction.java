...
public class AutoRotateAction extends ToggleAction {
	...
	public AutoRotateAction(Context context) {
		...
		mBroadcastIntent.setAction(context.getPackageName() + ".ROTATE_BUTTON_CLICKED");
	}
	...
	public boolean isStateOn() {
		boolean result = Settings.System.getInt(mContext.getContentResolver(), Settings.System.ACCELEROMETER_ROTATION, 1) == 1;
		return result;
	}
