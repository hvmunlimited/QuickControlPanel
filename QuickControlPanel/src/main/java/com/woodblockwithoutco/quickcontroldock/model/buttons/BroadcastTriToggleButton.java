...
public abstract class BroadcastTriToggleButton extends BaseTriToggleButton implements OnVisibilityEventListener {
	...
	private BroadcastReceiver mReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			BroadcastTriToggleButton.this.onReceive(intent);
		}
	};

	public BroadcastTriToggleButton(Context context, AttributeSet attrs, int defStyle) {
