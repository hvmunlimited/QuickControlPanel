...
public abstract class BaseLocalBroadcastActionSeekBar extends BaseBroadcastActionSeekBar {
	...
	public BaseLocalBroadcastActionSeekBar(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public BaseLocalBroadcastActionSeekBar(Context context, AttributeSet attrs, int defStyle) {
