...
public class ScreenTimeoutButton extends LocalBroadcastTriToggleButton {
	...
	public ScreenTimeoutButton(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ScreenTimeoutButton(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		mAction = new ScreenTimeoutAction(context.getApplicationContext());
